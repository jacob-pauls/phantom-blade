...
public class TPB_Character_Controller_Deprecated : MonoBehaviour {
    ...
    void CameraUpdate() 
    {
        ...
        {
            camera.transform.position = new Vector3(16f, 0f, -10f);
        }
        ...
        {
            camera.transform.position = new Vector3(-16f, 0, -10f);
        }
        //THETHISPOINTER
    }

    void HandleAnimationsAndMovement() 
    {
        ...
        if (inputX > 0 && !m_isFacingRight)
        {
            FlipCharacter();
            m_facingDirection = 1;
        }
            
        else if (inputX < 0 && m_isFacingRight)
        {
            FlipCharacter();
            m_facingDirection = -1;
        }
